...
return [
    ...
    | libre de modificar cada uno de estos mensajes aquí.
    |
    */
    ...
    | líneas. Esto facilita especificar una línea de lenguaje personalizada
    | rápidamente para una regla de atributo dada.
    |
    */
